<?php
	...
	$GLOBALS["LECTURE_LIST_COL_4"] = "Chỉnh sửa";
...
$GLOBALS["LECTURE_LECTURE_NO_IMAGE"] = "Không có ảnh.Bấm vào để thêm ảnh";
	...
	//road map
	$GLOBALS["LECTURE_DOWNLOAD_SAMPLE"] = "Tải về tệp mẫu";
	$GLOBALS["LECTURE_UPLOAD_PLAN"] = "Tải lên tệp mẫu";
	$GLOBALS["LECTURE_UPLOAD_PLAN_BUTTON_CHOOSE"] = "Bấm để chọn tệp";
	$GLOBALS["LECTURE_UPLOAD_PLAN_PLACEHOLDER"] = "Chọn tệp ...";
	$GLOBALS["LECTURE_ROADMAP_LECTURE"] = "Lộ trình khóa học";
	$GLOBALS["LECTURE_ROADMAP_COL_1"] = "Buổi";
	$GLOBALS["LECTURE_ROADMAP_COL_2"] = "Nội dung";
...
<script>
	var dictionary = {
		LECTURE_FILE_SAMPLE_NAME: "Bai_giang",
		LECTURE_ROADMAP_COL_1:"Buổi",
		LECTURE_ROADMAP_COL_2:"Nội dung",
	...
	var dictionaryKey = {
		LECTURE_FILE_SAMPLE_NAME:"LECTURE_FILE_SAMPLE_NAME",
		LECTURE_ROADMAP_COL_1:"LECTURE_ROADMAP_COL_1",
		LECTURE_ROADMAP_COL_2:"LECTURE_ROADMAP_COL_2",
		LECTURE_ROADMAP_COL_3:"LECTURE_ROADMAP_COL_3",
