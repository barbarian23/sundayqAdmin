            ...
            SunQAlert()
                ...
                .callback((result) => {
                    if (result.value) {
						...
						delete tempmyCurrentFreeLessonTemplate1.questions;
                        ...
                        requestToSever(
                            ...
                            getCurrentACtion() == dictionaryKey.editStatus ? getURLFreeLesson(getCurrentEdit()) : postURLFreeLessonPlan(ageID.freelesson1.id),
