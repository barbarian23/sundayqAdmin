...
//                 delete tempmyCurrentUploadVideo.kit;
//                 delete tempmyCurrentUploadVideo.kitId;
//                 delete tempmyCurrentUploadVideo.status;
//                 delete tempmyCurrentUploadVideo.id;
                //delete tempmyCurrentUploadVideo.transactions;
            }
            //console.log("push",tempmyCurrentUploadVideo);
            SunQAlert()
                .position('center')
