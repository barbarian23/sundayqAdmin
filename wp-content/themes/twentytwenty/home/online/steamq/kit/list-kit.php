<?php 
	include get_theme_file_path("home/online/steamq/kit/status-kit.php");
	include get_theme_file_path("home/online/steamq/kit/interact-ui-kit.php" ); 
?>
...
<div class="manage-list-lecture">
	<div class="manage-list-lecture-title-list-contain">
		...
		<div class="manage-list-lecture-add-new">
			<a href="?mode=online&page=steamq-kit&action=add">
				<button>
